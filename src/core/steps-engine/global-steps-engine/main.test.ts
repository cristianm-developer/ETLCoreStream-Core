...
describe('GlobalStepsEngineModule', () => {
    ...
    describe('handleSteps', () => {
        ...
        it('should handle abort signal', async () => {
            ...
            await expect(stepsEngineModule.handleSteps(layout, undefined, controller.signal)).rejects.toThrow();
        });
    ...
    describe('handleStepTransform', () => {
        ...
        it('should log transform execution', async () => {
            ...
            await stepsEngineModule['handleStepTransform'](
                step,
                transform,
                undefined,
                sourceStream
        ...
        it('should handle abort signal during transform', async () => {
            ...
            await expect(
                stepsEngineModule['handleStepTransform'](
                    step,
                    transform,
                    controller.signal,
                    sourceStream
        ...
        it('should use source rowsFn when no input stream provided', async () => {
            const rowsFnMock = vi.fn(() => new ReadableStream({
                start(controller) {
                    controller.enqueue({ rows: [createMockRowObject()] });
                    controller.close();
                }
