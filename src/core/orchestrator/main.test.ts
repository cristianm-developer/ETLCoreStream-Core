...
describe("OrchestatorModule - State Machine", () => {
  ...
  beforeEach(() => {
    ...
    const mockImporter = {
      readFileStream: vi.fn().mockReturnValue([ReadableStream.prototype as any, 100]),
    };
    ...
    const mockGlobalStepEngine = {
      handleStep: vi.fn().mockReturnValue(ReadableStream.prototype as any),
    };
    ...
    const mockExporter = {
      exportStream: vi.fn().mockResolvedValue(ReadableStream.prototype as any),
  ...
  describe("Initialization", () => {
    ...
    it("should generate a random ID if not provided", async () => {
      ...
      const orchestrator2 = new OrchestratorModule();
  ...
  describe("Error Handling", () => {
    ...
    it("should transition to error state when import fails", async () => {
      ...
      const orchestratorWithError = new OrchestratorModule();
  ...
  describe("Public API Functions", () => {
    ...
    describe("reset", () => {
      it("should send RESET event", async () => {
        ...
        const orchestratorToTest = new OrchestratorModule();
