...
describe('ViewerModule', () => {
    ...
    describe('editRow', () => {
        it('should update row field value', async () => {
            const row = createMockRowObject({ __rowId: 1, value: { name: 'John', email: 'john@test.com' } });
        ...
        it('should throw error if row not found', async () => {
            ...
            await expect(
                viewerModule.editRow(mockPersistenceModule, payload)
            ).rejects.toThrow('Row 999 not found');
        });
    ...
    describe('removeRow', () => {
        ...
        it('should throw error on deletion failure', async () => {
            ...
            await expect(
                viewerModule.removeRow(mockPersistenceModule, 1)
    ...
    describe('Integration tests', () => {
        it('should handle pagination, edit, and deletion workflow', async () => {
            ...
            const paginationResult = await viewerModule.getRowsWithPagination(mockPersistenceModule, metrics);
