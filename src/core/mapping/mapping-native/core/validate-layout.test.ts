...
describe("ValidateLayoutHeaders", () => {
  ...
  describe("Valid scenarios", () => {
    ...
    it("should validate headers with case-insensitive matching", () => {
      const headers = [createLayoutHeader({ key: "name", caseSensitive: false, required: true })];
      const row = { NAME: "John" };
    ...
    it("should validate row with extra columns not in headers", () => {
      const headers = [createLayoutHeader({ key: "name", required: true })];
  ...
  describe("Edge cases", () => {
    ...
    it("should handle row with numeric values", () => {
      const headers = [createLayoutHeader({ key: "age", required: true })];
      const row = { age: 25 };
    ...
    it("should handle row with boolean values", () => {
      const headers = [createLayoutHeader({ key: "active", required: true })];
