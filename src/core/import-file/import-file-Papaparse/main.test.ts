...
describe("ImportFilePapaparseModule", () => {
    ...
    it('should initialize with default config', () => {
        ...
        expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining('initialized'), 'debug', 'constructor', importer.id);
    ...
    it('should fail on empty file', () => {
        ...
        expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining('Validation failed: File is empty'), 'error', 'readFileStream', importer.id);
    ...
    it('should fail on invalid file format type', () => {
        ...
        expect(() => importer.readFileStream(file)).toThrow();
        expect(mockLogger.log).toHaveBeenCalledWith(expect.stringContaining('Validation failed: File type is not allowed'), 'error', 'readFileStream', importer.id);
